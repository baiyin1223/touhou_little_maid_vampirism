...
public class CollectBloodTask implements IMaidTask {
    private static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("touhou_little_maid_vampirism", "collect_blood");
    ...
    public ItemStack getIcon() {
        Item bloodBottle = BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath("vampirism", "blood_bottle"));
