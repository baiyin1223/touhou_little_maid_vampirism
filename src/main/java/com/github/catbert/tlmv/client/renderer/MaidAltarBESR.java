...
public class MaidAltarBESR implements BlockEntityRenderer<MaidAltarBlockEntity> {
    ...
    private final ResourceLocation enderDragonCrystalBeamTextures = new ResourceLocation("touhou_little_maid_vampirism", "textures/entity/infusion_beam.png");
    private final ResourceLocation beaconBeamTexture = new ResourceLocation("minecraft", "textures/entity/beacon_beam.png");
